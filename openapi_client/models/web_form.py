...
class WebForm(BaseModel):
    ...
    version_id: Optional[StrictInt] = Field(default=None, description="Identifier for the current version of the web form that is published", alias="versionId")
    form_content: Optional[WebFormContent] = Field(default=None, alias="formContent")
    __properties: ClassVar[List[str]] = ["id", "accountId", "isPublished", "isEnabled", "hasDraftChanges", "formState", "formProperties", "formMetadata", "versionId", "formContent"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of form_content
        if self.form_content:
            _dict['formContent'] = self.form_content.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "formContent": WebFormContent.from_dict(obj["formContent"]) if obj.get("formContent") is not None else None
        })
        return _obj
