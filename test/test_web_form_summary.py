...
class TestWebFormSummary(unittest.TestCase):
    """WebFormSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebFormSummary:
        """Test WebFormSummary
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebFormSummary`
        """
